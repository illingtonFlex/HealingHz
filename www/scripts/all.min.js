var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var n=e.split("."),a=HealingHz;"HealingHz"===n[0]&&(n=n.slice(1));for(var i=0;i<n.length;i++){var o=n[i];"undefined"==typeof a[o]&&(a[o]={}),a=a[o]}return a},HealingHz.postResults=function(e){},HealingHz.handleCorrectAnswer=function(){$("#victoryDiv").modal("show")},HealingHz.handleInorrectAnswer=function(){$("#failureDiv").modal("show")},HealingHz.checkNoteOrder=function(){var e=!0,n=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var a=HealingHz.markerBoxes[checki].getNote();n<=a.index?n=a.index:e=!1}return HealingHz.postResults(e),e===!0?HealingHz.handleCorrectAnswer():HealingHz.handleInorrectAnswer(),e},HealingHz.initAudio=function(e,n){console.log("Initializing chord: "+e.name);var a=e.getNotes(),i="audio/"+n+"/";console.log("audiopath: "+i);for(var o=[],r=0;r<a.length;r++){var t=a[r];o.push({id:t.fileName,src:t.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(o,i),createjs.Sound.registerSound("audio/1/C.ogg","voice1"),createjs.Sound.registerSound("audio/2/C.ogg","voice2"),createjs.Sound.registerSound("audio/3/C.ogg","voice3"),createjs.Sound.registerSound("audio/4/C.ogg","voice4")},HealingHz.playVoice=function(e){createjs.Sound.play("voice"+e)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],n=e.circle;createjs.Tween.get(n,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:n.origx,y:n.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){var e=new HealingHz.data.ChordFactory,n=e.getChord(),a=Math.floor(4*Math.random())+1;HealingHz.init(n,a)},HealingHz.initTestPlan=function(e,n){"0"===n&&(n=Math.floor(4*Math.random())+1),console.log(e);var a=new HealingHz.data.ChordFactory,i=a.getChord(e.chords[0].name);console.log(i),HealingHz.init(i,n)},HealingHz.init=function(e,n){HealingHz.curriculums=[];var a=document.getElementById("healingHzCanvas");a.addEventListener("touchstart",HealingHz.playSilentSound,!1);var o=HealingHz.model,r=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(r),HealingHz.NUM_MARKERS=e.getNotes().length,HealingHz.initAudio(e,n);var t=new o.NoteMarkerFactory;for(HealingHz.noteMarkers=t.buildNoteMarkers(e),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(r);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(r)}},window.onload=function(){if(location.search){for(var e={},n=location.search.substring(1).split("&"),a=0;a<n.length;a++){var i=n[a].split("=");i[0]&&(e[i[0]]=i[1]||!0)}$.getJSON("curriculums.json",function(n){for(var a=0;a<n.length;a++)n[a].id===e.c&&HealingHz.initTestPlan(n[a],e.v)})}else HealingHz.initStandalone()};
