var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var a=e.split("."),i=HealingHz;"HealingHz"===a[0]&&(a=a.slice(1));for(var n=0;n<a.length;n++){var o=a[n];"undefined"==typeof i[o]&&(i[o]={}),i=i[o]}return i},HealingHz.showVictoryText=function(){console.log("FAIL"),$("#victoryDiv").modal("show")},HealingHz.showFailureText=function(){console.log("FAIL"),$("#failureDiv").modal("show")},HealingHz.checkNoteOrder=function(){var e=!0,a=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var i=HealingHz.markerBoxes[checki].getNote();a<=i.index?a=i.index:e=!1}return e===!0?HealingHz.showVictoryText():HealingHz.showFailureText(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var a=e.getNotes(),i="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+i);for(var n=[],o=0;o<a.length;o++){var r=a[o];n.push({id:r.name,src:r.name+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(n,i)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],a=e.circle;createjs.Tween.get(a,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:a.origx,y:a.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.init=function(){var e=HealingHz.model,a=HealingHz.data,n=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(n);var o=new a.ChordFactory,r=o.getChord();HealingHz.NUM_MARKERS=r.getNotes().length,HealingHz.initAudio(r);var t=new e.NoteMarkerFactory;for(HealingHz.noteMarkers=t.buildNoteMarkers(r),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(n);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(n)}},window.onload=function(){HealingHz.init()};
