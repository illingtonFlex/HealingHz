var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var a=e.split("."),i=HealingHz;"HealingHz"===a[0]&&(a=a.slice(1));for(var n=0;n<a.length;n++){var r=a[n];"undefined"==typeof i[r]&&(i[r]={}),i=i[r]}return i},HealingHz.showVictoryText=function(){var e=document.getElementById("victoryDiv");e.style.display="block"},HealingHz.showFailureText=function(){var e=document.getElementById("failureDiv");e.style.display="block"},HealingHz.checkNoteOrder=function(){var e=!0,a=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var i=HealingHz.markerBoxes[checki].getNote();a<=i.index?a=i.index:e=!1}return e===!0?HealingHz.showVictoryText():HealingHz.showFailureText(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var a=e.getNotes(),i="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+i);for(var n=[],r=0;r<a.length;r++){var t=a[r];n.push({id:t.name,src:t.name+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(n,i)},HealingHz.reset=function(){var e=document.getElementById("failureDiv");for(e.style.display="none",mi=0;mi<HealingHz.noteMarkers.length;mi++){var a=HealingHz.noteMarkers[mi],i=a.circle;createjs.Tween.get(i,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:i.origx,y:i.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.init=function(){var e=HealingHz.model,a=HealingHz.data,n=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(n);var r=new a.ChordFactory,t=r.getChord();HealingHz.NUM_MARKERS=t.getNotes().length,HealingHz.initAudio(t);var o=new e.NoteMarkerFactory;for(HealingHz.noteMarkers=o.buildNoteMarkers(t),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(n);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(n)}},window.onload=function(){HealingHz.init()};
...
var ns=HealingHz.createNS("HealingHz.model");ns.NoteMarker=function(e,t,r,o,a,i){this.circle=new createjs.Shape,this.circle.origx=e,this.circle.origy=t,this.circle.x=e,this.circle.y=t,this.circle.rad=r,this.circle.color=o,this.circle.borderColor=a,this.note=i},ns.NoteMarker.prototype.draw=function(e){var t=this.circle,r=this.note;t.graphics.beginStroke(t.borderColor).beginFill(t.color).drawCircle(0,0,t.rad),t.on("pressmove",function(t){t.target.x=t.stageX,t.target.y=t.stageY,e.update()}),t.on("pressup",function(o){var a=0,l=0;for(createjs.Sound.play(r.name),console.log(r.name),boxi=0;boxi<HealingHz.markerBoxes.length;boxi++){var c=HealingHz.markerBoxes[boxi],s=o.target.localToLocal(0,0,c.box);c.box.hitTest(s.x,s.y)&&(a++,c.hasTooManyNoteMarkers()?createjs.Tween.get(t,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:o.target.origx,y:o.target.origy},1e3,createjs.Ease.getPowInOut(4)):(o.target.x=c.box.x+c.w/2,o.target.y=c.box.y+c.h/2)),c.isFull()&&l++}for(0===a&&createjs.Tween.get(t,{loop:!1}).to({x:o.target.origx,y:o.target.origy},1e3,createjs.Ease.getPowInOut(4)),createjs.Tween.get(t,{loop:!1}).to({alpha:0},250).to({alpha:1},500),createjs.Ticker.setFPS(60),createjs.Ticker.addEventListener("tick",e),l==HealingHz.markerBoxes.length&&HealingHz.checkNoteOrder(),i=0;i<HealingHz.noteMarkers.length;i++){HealingHz.noteMarkers[i]}}),e.addChild(t)};
