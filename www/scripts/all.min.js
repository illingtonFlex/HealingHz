var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var a=e.split("."),n=HealingHz;"HealingHz"===a[0]&&(a=a.slice(1));for(var i=0;i<a.length;i++){var o=a[i];"undefined"==typeof n[o]&&(n[o]={}),n=n[o]}return n},HealingHz.postResults=function(e){var a=[];for(si=0;si<HealingHz.NUM_MARKERS;si++)a.push(HealingHz.markerBoxes[si].getNote());var n='{"correctAnswer": "'+e+'", "chordName": "'+HealingHz.theChord.getName()+'", "notesPresented": '+JSON.stringify(HealingHz.theChord.getNotes())+', "solutionNotes": '+JSON.stringify(a)+"}";console.log(n),$.ajax({type:"POST",url:"http://104.131.64.136:8080/submitSolution",crossDomain:!0,data:n,contentType:"application/json; charset=utf-8",dataType:"json",success:function(e,a,n){console.log("POST Succeeded: "+JSON.stringify(e))},error:function(e,a,n){console.log("POST failed: "+JSON.stringify(e))}})},HealingHz.showVictoryText=function(){console.log("PASS"),$("#victoryDiv").modal("show")},HealingHz.showFailureText=function(){console.log("FAIL"),$("#failureDiv").modal("show")},HealingHz.checkNoteOrder=function(){var e=!0,a=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var n=HealingHz.markerBoxes[checki].getNote();a<=n.index?a=n.index:e=!1}return HealingHz.postResults(e),e===!0?HealingHz.showVictoryText():HealingHz.showFailureText(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var a=e.getNotes(),n="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+n);for(var i=[],o=0;o<a.length;o++){var t=a[o];i.push({id:t.fileName,src:t.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(i,n)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],a=e.circle;createjs.Tween.get(a,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:a.origx,y:a.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.init=function(){var e=document.getElementById("healingHzCanvas");e.addEventListener("touchstart",HealingHz.playSilentSound,!1);var a=HealingHz.model,n=HealingHz.data,o=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(o);var t=new n.ChordFactory;HealingHz.theChord=t.getChord(),HealingHz.NUM_MARKERS=HealingHz.theChord.getNotes().length,HealingHz.initAudio(HealingHz.theChord);var r=new a.NoteMarkerFactory;for(HealingHz.noteMarkers=r.buildNoteMarkers(HealingHz.theChord),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(o);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(o)}},window.onload=function(){HealingHz.init()};
