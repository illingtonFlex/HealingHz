var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var n=e.split("."),a=HealingHz;"HealingHz"===n[0]&&(n=n.slice(1));for(var i=0;i<n.length;i++){var t=n[i];"undefined"==typeof a[t]&&(a[t]={}),a=a[t]}return a},HealingHz.stage=null,HealingHz.SETTINGS={mode:"standalone",testPlanIterator:0,currentTestPlan:null,currentVoice:0},HealingHz.postResults=function(e){},HealingHz.handleCorrectAnswer=function(){"testplan"!=HealingHz.SETTINGS.mode?$("#victoryDiv").modal("show"):HealingHz.processSubmission()},HealingHz.handleInorrectAnswer=function(){"testplan"!=HealingHz.SETTINGS.mode?$("#failureDiv").modal("show"):HealingHz.processSubmission()},HealingHz.processSubmission=function(){HealingHz.SETTINGS.testPlanIterator++;for(var e=(new HealingHz.data.ChordFactory).getChord(HealingHz.SETTINGS.currentTestPlan.chords[HealingHz.SETTINGS.testPlanIterator].name),n=0;n<HealingHz.noteMarkers.length;n++)HealingHz.stage.removeChild(HealingHz.noteMarkers[n].circle),HealingHz.stage.removeChild(HealingHz.markerBoxes[n].box);console.log(e),HealingHz.init(e,HealingHz.SETTINGS.currentVoice)},HealingHz.checkNoteOrder=function(){var e=!0,n=0;for(checki=0;checki<HealingHz.markerBoxes.length;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var a=HealingHz.markerBoxes[checki].getNote();n<=a.index?n=a.index:e=!1}return HealingHz.postResults(e),e===!0?HealingHz.handleCorrectAnswer():HealingHz.handleInorrectAnswer(),e},HealingHz.initAudio=function(e,n){console.log("Initializing chord: "+e.name);var a=e.getNotes(),i="audio/"+n+"/";console.log("audiopath: "+i);for(var t=[],o=0;o<a.length;o++){var r=a[o];t.push({id:r.fileName,src:r.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(t,i),createjs.Sound.registerSound("audio/1/C.ogg","voice1"),createjs.Sound.registerSound("audio/2/C.ogg","voice2"),createjs.Sound.registerSound("audio/3/C.ogg","voice3"),createjs.Sound.registerSound("audio/4/C.ogg","voice4")},HealingHz.playVoice=function(e){createjs.Sound.play("voice"+e)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],n=e.circle;createjs.Tween.get(n,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:n.origx,y:n.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){var e=(new HealingHz.data.ChordFactory).getChord(),n=Math.floor(4*Math.random())+1;HealingHz.init(e,n)},HealingHz.initTestPlan=function(e,n){console.log(e),"0"===n&&(n=Math.floor(4*Math.random())+1);var a=(new HealingHz.data.ChordFactory).getChord(e.chords[HealingHz.SETTINGS.testPlanIterator].name);HealingHz.init(a,n),HealingHz.SETTINGS.mode="testplan",HealingHz.SETTINGS.currentTestPlan=e,HealingHz.SETTINGS.currentVoice=n},HealingHz.init=function(e,n){var a=document.getElementById("healingHzCanvas");a.addEventListener("touchstart",HealingHz.playSilentSound,!1);var i=HealingHz.model;null===HealingHz.stage&&(HealingHz.stage=new createjs.Stage("healingHzCanvas"),createjs.Touch.enable(HealingHz.stage)),HealingHz.initAudio(e,n),HealingHz.noteMarkers=(new i.NoteMarkerFactory).buildNoteMarkers(e),HealingHz.markerBoxes=[];for(var t=0;t<HealingHz.noteMarkers.length;t++)HealingHz.noteMarkers[t].draw(HealingHz.stage);for(t=0;t<e.getNotes().length;t++){var o=(690+10*t)/e.getNotes().length+110*t;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(o,50,"white","black")),HealingHz.markerBoxes[t].draw(HealingHz.stage)}},window.onload=function(){if(location.search){for(var e={},n=location.search.substring(1).split("&"),a=0;a<n.length;a++){var i=n[a].split("=");i[0]&&(e[i[0]]=i[1]||!0)}$.getJSON("curriculums.json",function(n){for(var a=0;a<n.length;a++)n[a].id===e.c&&(HealingHz.SETTINGS.currentVoice=e.v,HealingHz.SETTINGS.currentTestPlan=n[a],HealingHz.initTestPlan(n[a],e.v))})}else HealingHz.initStandalone()};
