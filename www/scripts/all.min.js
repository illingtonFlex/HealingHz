var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var n=e.split("."),a=HealingHz;"HealingHz"===n[0]&&(n=n.slice(1));for(var t=0;t<n.length;t++){var r=n[t];"undefined"==typeof a[r]&&(a[r]={}),a=a[r]}return a},HealingHz.stage=null,HealingHz.testPlanResults={notesPresented:[],notesSubmitted:[],voice:null},HealingHz.SETTINGS={mode:"standalone",testPlanIterator:0,currentTestPlan:null,currentVoice:0},HealingHz.postResults=function(e){console.log(e)},HealingHz.handleCorrectAnswer=function(){"testplan"!=HealingHz.SETTINGS.mode?$("#victoryDiv").modal("show"):HealingHz.processSubmission()},HealingHz.handleInorrectAnswer=function(){"testplan"!=HealingHz.SETTINGS.mode?$("#failureDiv").modal("show"):HealingHz.processSubmission()},HealingHz.processSubmission=function(){for(var e=[],n=0;n<HealingHz.noteMarkers.length;n++)e.push(HealingHz.noteMarkers[n].note);for(HealingHz.testPlanResults.notesPresented.push(e),HealingHz.testPlanResults.voice=HealingHz.SETTINGS.currentVoice,HealingHz.postResults(HealingHz.testPlanResults),n=0;n<HealingHz.noteMarkers.length;n++)HealingHz.stage.removeChild(HealingHz.noteMarkers[n].circle),HealingHz.stage.removeChild(HealingHz.markerBoxes[n].box);HealingHz.SETTINGS.testPlanIterator++;var a=document.querySelector('[ng-app="HealingHz-CurriculumUI"]'),t=angular.element(a).scope();if(HealingHz.SETTINGS.testPlanIterator<HealingHz.SETTINGS.currentTestPlan.chords.length){var r=HealingHz.getCurrentChord();HealingHz.init(r,HealingHz.SETTINGS.currentVoice),t.$apply(function(){t.testPlanIterator=HealingHz.SETTINGS.testPlanIterator})}else t.$apply(function(){t.results=HealingHz.testPlanResults}),$("#resultsDiv").modal("show")},HealingHz.getCurrentChord=function(){var e=(new HealingHz.data.ChordFactory).getChord(HealingHz.SETTINGS.currentTestPlan.chords[HealingHz.SETTINGS.testPlanIterator].name);return e},HealingHz.checkNoteOrder=function(){for(var e=!0,n=0,a=[],t=0;t<HealingHz.markerBoxes.length;t++){if(!HealingHz.markerBoxes[t].isFull())return!1;var r=HealingHz.markerBoxes[t].getNote();a.push(r),n<=r.index?n=r.index:e=!1}return HealingHz.testPlanResults.notesSubmitted.push(a),e===!0?HealingHz.handleCorrectAnswer():HealingHz.handleInorrectAnswer(),e},HealingHz.initAudio=function(e,n){var a=e.getNotes();"0"===n&&(n=Math.floor(4*Math.random())+1);for(var t="audio/"+n+"/",r=[],l=0;l<a.length;l++){var i=a[l];r.push({id:i.fileName,src:i.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(r,t),createjs.Sound.registerSound("audio/1/C.ogg","voice1"),createjs.Sound.registerSound("audio/2/C.ogg","voice2"),createjs.Sound.registerSound("audio/3/C.ogg","voice3"),createjs.Sound.registerSound("audio/4/C.ogg","voice4")},HealingHz.playVoice=function(e){"0"===e&&(e=Math.floor(4*Math.random())+1),createjs.Sound.play("voice"+e)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],n=e.circle;createjs.Tween.get(n,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:n.origx,y:n.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){var e=(new HealingHz.data.ChordFactory).getChord(),n=Math.floor(4*Math.random())+1;HealingHz.init(e,n)},HealingHz.initTestPlan=function(e,n){$("#explanationDiv").hide(),$("#navBar").hide();var a=document.querySelector('[ng-app="HealingHz-CurriculumUI"]'),t=angular.element(a).scope();t.$apply(function(){t.selectedCurriculum=e,t.selectedVoice=n,t.testPlanIterator=HealingHz.SETTINGS.testPlanIterator});var r=(new HealingHz.data.ChordFactory).getChord(e.chords[HealingHz.SETTINGS.testPlanIterator].name);HealingHz.init(r,n),HealingHz.SETTINGS.mode="testplan",HealingHz.SETTINGS.currentTestPlan=e,HealingHz.SETTINGS.currentVoice=n,$("#testPlanStatusDiv").show(),$("#beginTestPlanModal").modal("show")},HealingHz.init=function(e,n){var a=document.getElementById("healingHzCanvas");a.addEventListener("touchstart",HealingHz.playSilentSound,!1);var t=HealingHz.model;null===HealingHz.stage&&(HealingHz.stage=new createjs.Stage("healingHzCanvas"),createjs.Touch.enable(HealingHz.stage)),HealingHz.initAudio(e,n),HealingHz.noteMarkers=(new t.NoteMarkerFactory).buildNoteMarkers(e),HealingHz.markerBoxes=[];for(var r=0;r<HealingHz.noteMarkers.length;r++)HealingHz.noteMarkers[r].draw(HealingHz.stage);for(r=0;r<e.getNotes().length;r++){var l=(690+10*r)/e.getNotes().length+110*r;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[r].draw(HealingHz.stage)}},window.onload=function(){if(location.search){for(var e={},n=location.search.substring(1).split("&"),a=0;a<n.length;a++){var t=n[a].split("=");t[0]&&(e[t[0]]=t[1]||!0)}$.getJSON("curriculums.json",function(n){for(var a=0;a<n.length;a++)n[a].id===e.c&&(n[a].chords.sort(function(){return.5-Math.random()}),HealingHz.SETTINGS.currentVoice=e.v,HealingHz.SETTINGS.currentTestPlan=n[a],HealingHz.initTestPlan(n[a],e.v))})}else HealingHz.initStandalone()};
