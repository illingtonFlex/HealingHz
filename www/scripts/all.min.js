var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var n=e.split("."),i=HealingHz;"HealingHz"===n[0]&&(n=n.slice(1));for(var a=0;a<n.length;a++){var o=n[a];"undefined"==typeof i[o]&&(i[o]={}),i=i[o]}return i},HealingHz.postResults=function(e){var n=[];for(si=0;si<HealingHz.NUM_MARKERS;si++)n.push(HealingHz.markerBoxes[si].getNote());var i='{"correctAnswer": "'+e+'", "chordName": "'+HealingHz.theChord.getName()+'", "notesPresented": '+JSON.stringify(HealingHz.theChord.getNotes())+', "solutionNotes": '+JSON.stringify(n)+"}";console.log(i),$.ajax({type:"POST",url:"http://104.131.64.136:8080/submitSolution",crossDomain:!0,data:i,contentType:"application/json; charset=utf-8",dataType:"json",success:function(e,n,i){console.log("POST Succeeded: "+JSON.stringify(e))},error:function(e,n,i){console.log("POST failed: "+JSON.stringify(e))}})},HealingHz.handleCorrectAnswer=function(){$("#victoryDiv").modal("show")},HealingHz.handleInorrectAnswer=function(){$("#failureDiv").modal("show")},HealingHz.checkNoteOrder=function(){var e=!0,n=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var i=HealingHz.markerBoxes[checki].getNote();n<=i.index?n=i.index:e=!1}return HealingHz.postResults(e),e===!0?HealingHz.handleCorrectAnswer():HealingHz.handleInorrectAnswer(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var n=e.getNotes(),i="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+i);for(var a=[],o=0;o<n.length;o++){var t=n[o];a.push({id:t.fileName,src:t.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(a,i),createjs.Sound.registerSound("audio/1/C.ogg","voice1"),createjs.Sound.registerSound("audio/2/C.ogg","voice2"),createjs.Sound.registerSound("audio/3/C.ogg","voice3"),createjs.Sound.registerSound("audio/4/C.ogg","voice4")},HealingHz.playVoice=function(e){createjs.Sound.play("voice"+e)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],n=e.circle;createjs.Tween.get(n,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:n.origx,y:n.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){var e=new HealingHz.data.ChordFactory,n=e.getChord();HealingHz.init(n)},HealingHz.initTestPlan=function(e,n){console.log(e),console.log("Chosen voice: "+n);var i=new HealingHz.data.ChordFactory,a=i.getChord(e.chords[0].name);console.log(a),HealingHz.init(a)},HealingHz.init=function(e){HealingHz.curriculums=[];var n=document.getElementById("healingHzCanvas");n.addEventListener("touchstart",HealingHz.playSilentSound,!1);var a=HealingHz.model,o=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(o),HealingHz.theChord=e,HealingHz.NUM_MARKERS=HealingHz.theChord.getNotes().length,HealingHz.initAudio(HealingHz.theChord);var t=new a.NoteMarkerFactory;for(HealingHz.noteMarkers=t.buildNoteMarkers(HealingHz.theChord),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(o);for(i=0;i<HealingHz.NUM_MARKERS;i++){var r=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(r,50,"white","black")),HealingHz.markerBoxes[i].draw(o)}},window.onload=function(){if(location.search){for(var e={},n=location.search.substring(1).split("&"),i=0;i<n.length;i++){var a=n[i].split("=");a[0]&&(e[a[0]]=a[1]||!0)}$.getJSON("curriculums.json",function(n){for(var i=0;i<n.length;i++)n[i].id===e.c&&HealingHz.initTestPlan(n[i],e.v)})}else HealingHz.initStandalone()};
