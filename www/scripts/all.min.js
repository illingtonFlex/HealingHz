var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var n=e.split("."),a=HealingHz;"HealingHz"===n[0]&&(n=n.slice(1));for(var i=0;i<n.length;i++){var o=n[i];"undefined"==typeof a[o]&&(a[o]={}),a=a[o]}return a},HealingHz.postResults=function(e){var n=[];for(si=0;si<HealingHz.NUM_MARKERS;si++)n.push(HealingHz.markerBoxes[si].getNote());var a='{"correctAnswer": "'+e+'", "chordName": "'+HealingHz.theChord.getName()+'", "notesPresented": '+JSON.stringify(HealingHz.theChord.getNotes())+', "solutionNotes": '+JSON.stringify(n)+"}";console.log(a),$.ajax({type:"POST",url:"http://104.131.64.136:8080/submitSolution",crossDomain:!0,data:a,contentType:"application/json; charset=utf-8",dataType:"json",success:function(e,n,a){console.log("POST Succeeded: "+JSON.stringify(e))},error:function(e,n,a){console.log("POST failed: "+JSON.stringify(e))}})},HealingHz.showVictoryText=function(){console.log("PASS"),$("#victoryDiv").modal("show")},HealingHz.showFailureText=function(){console.log("FAIL"),$("#failureDiv").modal("show")},HealingHz.checkNoteOrder=function(){var e=!0,n=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var a=HealingHz.markerBoxes[checki].getNote();n<=a.index?n=a.index:e=!1}return HealingHz.postResults(e),e===!0?HealingHz.showVictoryText():HealingHz.showFailureText(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var n=e.getNotes(),a="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+a);for(var i=[],o=0;o<n.length;o++){var t=n[o];i.push({id:t.fileName,src:t.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(i,a)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],n=e.circle;createjs.Tween.get(n,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:n.origx,y:n.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){},HealingHz.init=function(){var e=document.getElementById("healingHzCanvas");e.addEventListener("touchstart",HealingHz.playSilentSound,!1);var n=HealingHz.model,a=HealingHz.data,o=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(o);var t=new a.ChordFactory;HealingHz.theChord=t.getChord(),HealingHz.NUM_MARKERS=HealingHz.theChord.getNotes().length,HealingHz.initAudio(HealingHz.theChord);var r=new n.NoteMarkerFactory;for(HealingHz.noteMarkers=r.buildNoteMarkers(HealingHz.theChord),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(o);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(o)}},window.onload=function(){HealingHz.init()};
