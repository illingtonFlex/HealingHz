var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var i=e.split("."),n=HealingHz;"HealingHz"===i[0]&&(i=i.slice(1));for(var o=0;o<i.length;o++){var a=i[o];"undefined"==typeof n[a]&&(n[a]={}),n=n[a]}return n},HealingHz.postResults=function(e){var i=[];for(si=0;si<HealingHz.NUM_MARKERS;si++)i.push(HealingHz.markerBoxes[si].getNote());var n='{"correctAnswer": "'+e+'", "chordName": "'+HealingHz.theChord.getName()+'", "notesPresented": '+JSON.stringify(HealingHz.theChord.getNotes())+', "solutionNotes": '+JSON.stringify(i)+"}";console.log(n),$.ajax({type:"POST",url:"http://104.131.64.136:8080/submitSolution",crossDomain:!0,data:n,contentType:"application/json; charset=utf-8",dataType:"json",success:function(e,i,n){console.log("POST Succeeded: "+JSON.stringify(e))},error:function(e,i,n){console.log("POST failed: "+JSON.stringify(e))}})},HealingHz.showVictoryText=function(){console.log("PASS"),$("#victoryDiv").modal("show")},HealingHz.showFailureText=function(){console.log("FAIL"),$("#failureDiv").modal("show")},HealingHz.checkNoteOrder=function(){var e=!0,i=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var n=HealingHz.markerBoxes[checki].getNote();i<=n.index?i=n.index:e=!1}return HealingHz.postResults(e),e===!0?HealingHz.showVictoryText():HealingHz.showFailureText(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var i=e.getNotes(),n="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+n);for(var o=[],a=0;a<i.length;a++){var t=i[a];o.push({id:t.fileName,src:t.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(o,n),createjs.Sound.registerSound("audio/1/C.ogg","voice1"),createjs.Sound.registerSound("audio/2/C.ogg","voice2"),createjs.Sound.registerSound("audio/3/C.ogg","voice3"),createjs.Sound.registerSound("audio/4/C.ogg","voice4")},HealingHz.playVoice=function(e){createjs.Sound.play("voice"+e)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],i=e.circle;createjs.Tween.get(i,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:i.origx,y:i.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){},HealingHz.init=function(){HealingHz.curriculums=[],$.getJSON("curriculums.json",function(e){HealingHz.curriculums=e});var e=document.getElementById("healingHzCanvas");e.addEventListener("touchstart",HealingHz.playSilentSound,!1);var n=HealingHz.model,o=HealingHz.data,a=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(a);var t=new o.ChordFactory;HealingHz.theChord=t.getChord(),HealingHz.NUM_MARKERS=HealingHz.theChord.getNotes().length,HealingHz.initAudio(HealingHz.theChord);var r=new n.NoteMarkerFactory;for(HealingHz.noteMarkers=r.buildNoteMarkers(HealingHz.theChord),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(a);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(a)}},window.onload=function(){HealingHz.init()};
