var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var n=e.split("."),a=HealingHz;"HealingHz"===n[0]&&(n=n.slice(1));for(var t=0;t<n.length;t++){var i=n[t];"undefined"==typeof a[i]&&(a[i]={}),a=a[i]}return a},HealingHz.stage=null,HealingHz.testPlanResults={notesPresented:[],notesSubmitted:[],voice:null},HealingHz.SETTINGS={mode:"standalone",testPlanIterator:0,currentTestPlan:null,currentVoice:0},HealingHz.postResults=function(e){console.log(e)},HealingHz.handleCorrectAnswer=function(){"testplan"!=HealingHz.SETTINGS.mode?$("#victoryDiv").modal("show"):HealingHz.processSubmission()},HealingHz.handleInorrectAnswer=function(){"testplan"!=HealingHz.SETTINGS.mode?$("#failureDiv").modal("show"):HealingHz.processSubmission()},HealingHz.processSubmission=function(){for(var e=[],n=0;n<HealingHz.noteMarkers.length;n++)e.push(HealingHz.noteMarkers[n].note);HealingHz.testPlanResults.notesPresented.push(e),HealingHz.testPlanResults.voice=HealingHz.SETTINGS.currentVoice,HealingHz.postResults(HealingHz.testPlanResults),HealingHz.SETTINGS.testPlanIterator++;var a=HealingHz.getCurrentChord();for(n=0;n<HealingHz.noteMarkers.length;n++)HealingHz.stage.removeChild(HealingHz.noteMarkers[n].circle),HealingHz.stage.removeChild(HealingHz.markerBoxes[n].box);HealingHz.init(a,HealingHz.SETTINGS.currentVoice)},HealingHz.getCurrentChord=function(){var e=(new HealingHz.data.ChordFactory).getChord(HealingHz.SETTINGS.currentTestPlan.chords[HealingHz.SETTINGS.testPlanIterator].name);return e},HealingHz.checkNoteOrder=function(){for(var e=!0,n=0,a=[],t=0;t<HealingHz.markerBoxes.length;t++){if(!HealingHz.markerBoxes[t].isFull())return!1;var i=HealingHz.markerBoxes[t].getNote();a.push(i),n<=i.index?n=i.index:e=!1}return HealingHz.testPlanResults.notesSubmitted.push(a),e===!0?HealingHz.handleCorrectAnswer():HealingHz.handleInorrectAnswer(),e},HealingHz.initAudio=function(e,n){for(var a=e.getNotes(),t="audio/"+n+"/",i=[],r=0;r<a.length;r++){var o=a[r];i.push({id:o.fileName,src:o.fileName+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(i,t),createjs.Sound.registerSound("audio/1/C.ogg","voice1"),createjs.Sound.registerSound("audio/2/C.ogg","voice2"),createjs.Sound.registerSound("audio/3/C.ogg","voice3"),createjs.Sound.registerSound("audio/4/C.ogg","voice4")},HealingHz.playVoice=function(e){createjs.Sound.play("voice"+e)},HealingHz.reset=function(){for(mi=0;mi<HealingHz.noteMarkers.length;mi++){var e=HealingHz.noteMarkers[mi],n=e.circle;createjs.Tween.get(n,{loop:!1}).to({alpha:0},50).to({alpha:1},50).to({alpha:0},50).to({alpha:1},50).to({x:n.origx,y:n.origy},1e3,createjs.Ease.getPowInOut(4))}},HealingHz.playSilentSound=function(){createjs.WebAudioPlugin.playEmptySound()},HealingHz.initStandalone=function(){var e=(new HealingHz.data.ChordFactory).getChord(),n=Math.floor(4*Math.random())+1;HealingHz.init(e,n)},HealingHz.initTestPlan=function(e,n){console.log(e),"0"===n&&(n=Math.floor(4*Math.random())+1);var a=(new HealingHz.data.ChordFactory).getChord(e.chords[HealingHz.SETTINGS.testPlanIterator].name);HealingHz.init(a,n),HealingHz.SETTINGS.mode="testplan",HealingHz.SETTINGS.currentTestPlan=e,HealingHz.SETTINGS.currentVoice=n},HealingHz.init=function(e,n){var a=document.getElementById("healingHzCanvas");a.addEventListener("touchstart",HealingHz.playSilentSound,!1);var t=HealingHz.model;null===HealingHz.stage&&(HealingHz.stage=new createjs.Stage("healingHzCanvas"),createjs.Touch.enable(HealingHz.stage)),HealingHz.initAudio(e,n),HealingHz.noteMarkers=(new t.NoteMarkerFactory).buildNoteMarkers(e),HealingHz.markerBoxes=[];for(var i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(HealingHz.stage);for(i=0;i<e.getNotes().length;i++){var r=(690+10*i)/e.getNotes().length+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(r,50,"white","black")),HealingHz.markerBoxes[i].draw(HealingHz.stage)}},window.onload=function(){if(location.search){for(var e={},n=location.search.substring(1).split("&"),a=0;a<n.length;a++){var t=n[a].split("=");t[0]&&(e[t[0]]=t[1]||!0)}$.getJSON("curriculums.json",function(n){for(var a=0;a<n.length;a++)n[a].id===e.c&&(HealingHz.SETTINGS.currentVoice=e.v,HealingHz.SETTINGS.currentTestPlan=n[a],HealingHz.initTestPlan(n[a],e.v))})}else HealingHz.initStandalone()};
