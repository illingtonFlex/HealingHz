var HealingHz=HealingHz||{};HealingHz.createNS=function(e){var i=e.split("."),a=HealingHz;"HealingHz"===i[0]&&(i=i.slice(1));for(var n=0;n<i.length;n++){var r=i[n];"undefined"==typeof a[r]&&(a[r]={}),a=a[r]}return a},HealingHz.showVictoryText=function(){var e=document.getElementById("victoryDiv");e.style.display="block"},HealingHz.showFailureText=function(){var e=document.getElementById("failureDiv");e.style.display="block"},HealingHz.checkNoteOrder=function(){var e=!0,i=0;for(checki=0;checki<HealingHz.NUM_MARKERS;checki++){if(!HealingHz.markerBoxes[checki].isFull())return!1;var a=HealingHz.markerBoxes[checki].getNote();i<=a.index?i=a.index:e=!1}return e===!0?HealingHz.showVictoryText():HealingHz.showFailureText(),e},HealingHz.initAudio=function(e){console.log("Initializing chord: "+e.name);var i=e.getNotes(),a="audio/"+(Math.floor(4*Math.random())+1)+"/";console.log("audiopath: "+a);for(var n=[],r=0;r<i.length;r++){var o=i[r];n.push({id:o.name,src:o.name+".ogg"})}createjs.Sound.alternateExtensions=["mp3","wav"],createjs.Sound.registerSounds(n,a)},HealingHz.reset=function(){},HealingHz.init=function(){var e=HealingHz.model,a=HealingHz.data,n=new createjs.Stage("healingHzCanvas");createjs.Touch.enable(n);var r=new a.ChordFactory,o=r.getChord();HealingHz.NUM_MARKERS=o.getNotes().length,HealingHz.initAudio(o);var t=new e.NoteMarkerFactory;for(HealingHz.noteMarkers=t.buildNoteMarkers(o),HealingHz.markerBoxes=[],i=0;i<HealingHz.noteMarkers.length;i++)HealingHz.noteMarkers[i].draw(n);for(i=0;i<HealingHz.NUM_MARKERS;i++){var l=(690+10*i)/HealingHz.NUM_MARKERS+110*i;HealingHz.markerBoxes.push(new HealingHz.model.NoteMarkerBox(l,50,"white","black")),HealingHz.markerBoxes[i].draw(n)}},window.onload=function(){HealingHz.init()};
